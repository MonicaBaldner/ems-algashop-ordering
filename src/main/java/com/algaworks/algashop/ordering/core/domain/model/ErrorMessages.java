...
public class ErrorMessages {
    ...
    public static final String VALIDATION_ERROR_ZIPCODE_MUST_HAVE_FIVE_CHARACTERS = "ZipCode must have five characters";
    ...
    public static final String ERROR_CUSTOMER_ALREADY_HAVE_SHOPPING_CART ="Customer %s already have shopping cart";
