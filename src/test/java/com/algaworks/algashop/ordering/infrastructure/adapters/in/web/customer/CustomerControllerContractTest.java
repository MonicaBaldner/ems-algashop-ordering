...
import com.algaworks.algashop.ordering.core.application.customer.management.CustomerJsonSamples;
...
class CustomerControllerContractTest {
    ...
    public void createCustomerContract() {
        ...
        String jsonInput = CustomerJsonSamples.validJsonInput();
    ...
    public void createCustomerError400Contract() {
        ...
        String jsonInput = CustomerJsonSamples.invalidJsonInput();
    ...
    public void updateCustomerError400Contract() {
        ...
        Mockito.doThrow(DomainEntityBadRequestException.class)
                .when(customerManagementApplicationService)
                .update(Mockito.any(UUID.class), Mockito.any(CustomerUpdateInput.class));

        UUID customerId = UUID.randomUUID();

        String invalidJsonInput = CustomerJsonSamples.invalidJsonInput();


        RestAssuredMockMvc
                .given()
                .accept(MediaType.APPLICATION_JSON_VALUE)
                .body(invalidJsonInput)
                .contentType(MediaType.APPLICATION_JSON_VALUE)
                .when()
                .put("/api/v1/customers/{customerId}",customerId)
                .then()
    ...
    public void updateCustomerError409Contract() {
        ...
        Mockito.doThrow(new CustomerEmailIsInUseException(new CustomerId(customerId)))
                .when(customerManagementApplicationService).update(Mockito.eq(customerId), Mockito.any());
    ...
    public void updateCustomerError422Contract() {
        ...
        Mockito.doThrow(new DomainException("Erro de domínio"))
                .when(customerManagementApplicationService)
    ...
    public void deleteCustomerError404Contract() {
        ...
        Mockito.doThrow(new CustomerNotFoundException())
                .when(customerManagementApplicationService).archive(Mockito.eq(invalidCustomerId));
    ...
    public void deleteCustomerError422Contract() {
        ...
        Mockito.doThrow(new DomainException("Cliente já arquivado"))
                .when(customerManagementApplicationService).archive(Mockito.eq(customerId));
